          ...
          <div className="relative z-30 flex w-[268px] flex-col gap-8 rounded-3xl bg-white px-7 py-8 md:left-[7%] lg:top-20">
            <div className="flex flex-col">
              <div className="flexBetween">
                <p className="regular-14 text-gray-80 text-[12px]">cn xsmcmf</p>
                <Image src="/close.svg" alt="close" width={24} height={24} />
              </div>
              <p className="bold-16 text-customLBlue">zc mznd,nfksdl</p>
            </div>
            <div className="flexBetween">
              <div className="flex flex-col">
                <p className="regular-14 block text-gray-80">dkn,fnsdg</p>
                <p className="bold-16 text-customLBlue">173.28</p>
              </div>
              <div className="flex flex-col">
                <p className="regular-14 block text-gray-80">zs mfdzsmfnks</p>
                <p className="bold-16 text-customLBlue">2.040 km</p>
              </div>
            </div>
          </div>
        </div>

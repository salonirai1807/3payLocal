  ...
  return (
    <div id='how' className='p-20 bg-customLBlue'>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
        <WobbleCard
          containerClassName="col-span-1 border-2 border-customDBlue bg-customLBlue lg:col-span-2 h-full min-h-[500px] lg:min-h-[300px] hover:bg-zinc-900 transition-colors duration-300"
        >
        ...
        <WobbleCard
          containerClassName="col-span-1 border-2 border-customDBlue bg-customLBlue min-h-[300px] hover:bg-zinc-900 transition-colors duration-300"
        >
        ...
        <WobbleCard
          containerClassName="col-span-1 border-2 border-customDBlue lg:col-span-3 bg-customLBlue min-h-[500px] lg:min-h-[600px] xl:min-h-[300px] hover:bg-zinc-900 transition-colors duration-300"
        >
